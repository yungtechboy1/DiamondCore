...
There are also CustomPackets and InternalPackets, which we will get to later.

ID_CONNECTED_PING_OPEN_CONNECTIONS (C -> S)
-----------------
...
MAGIC      | MAGIC  | (See above)
Identifier | String | A string put together in this order: "MCPE;Owner;Protocol;ProtocolTag;OnlinePlayers;MaxPlayers"
