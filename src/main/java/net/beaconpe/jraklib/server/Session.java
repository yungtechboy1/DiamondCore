...
import net.beaconpe.jraklib.protocol.ACK;
import net.beaconpe.jraklib.protocol.CLIENT_CONNECT_DataPacket;
import net.beaconpe.jraklib.protocol.CLIENT_DISCONNECT_DataPacket;
import net.beaconpe.jraklib.protocol.CLIENT_HANDSHAKE_DataPacket;
import net.beaconpe.jraklib.protocol.DataPacket;
import net.beaconpe.jraklib.protocol.DataPackets;
import net.beaconpe.jraklib.protocol.EncapsulatedPacket;
import net.beaconpe.jraklib.protocol.NACK;
import net.beaconpe.jraklib.protocol.OPEN_CONNECTION_REPLY_1;
import net.beaconpe.jraklib.protocol.OPEN_CONNECTION_REPLY_2;
import net.beaconpe.jraklib.protocol.OPEN_CONNECTION_REQUEST_1;
import net.beaconpe.jraklib.protocol.OPEN_CONNECTION_REQUEST_2;
import net.beaconpe.jraklib.protocol.PING_DataPacket;
import net.beaconpe.jraklib.protocol.PONG_DataPacket;
import net.beaconpe.jraklib.protocol.Packet;
import net.beaconpe.jraklib.protocol.SERVER_HANDSHAKE_DataPacket;
